...
# Form implementation generated from reading ui file 'C:\Work\Python\PyQt5\PyQt5_Test1\SaveForm.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_Exit.setGeometry(QtCore.QRect(153, 108, 82, 37))
        icon = QtGui.QIcon()
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "SaveForm"))
