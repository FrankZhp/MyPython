...
# Form implementation generated from reading ui file 'C:\Work\Python\PyQt5\PyQt5_Test1\OpenForm.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btn_Exit.setGeometry(QtCore.QRect(144, 108, 73, 37))
        icon = QtGui.QIcon()
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "OpenForm"))
