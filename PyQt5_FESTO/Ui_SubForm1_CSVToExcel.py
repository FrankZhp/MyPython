...
# Form implementation generated from reading ui file 'C:\Work\Python\PyQt5\PyQt5_FESTO\SubForm1_CSVToExcel.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.txt_File = QtWidgets.QPlainTextEdit(Form)
        self.txt_File.setGeometry(QtCore.QRect(140, 30, 491, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Step 1 CSV To Excel"))
        self.btn_Process.setText(_translate("Form", "Process"))
        self.btn_Exit.setText(_translate("Form", "Exit"))
        self.label.setText(_translate("Form", "Select CSV File:"))
