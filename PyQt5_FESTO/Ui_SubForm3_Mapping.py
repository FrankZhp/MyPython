...
# Form implementation generated from reading ui file 'C:\Work\Python\PyQt5\PyQt5_FESTO\SubForm3_Mapping.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QtCore.QRect(27, 30, 121, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.txt_MergedExcel = QtWidgets.QPlainTextEdit(Form)
        self.txt_MergedExcel.setGeometry(QtCore.QRect(140, 30, 491, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.txt_MergedExcel.setFont(font)
        self.txt_MergedExcel.setPlainText("")
        self.txt_MergedExcel.setObjectName("txt_MergedExcel")
        self.btn_Browse_2 = QtWidgets.QPushButton(Form)
        self.btn_Browse_2.setGeometry(QtCore.QRect(640, 80, 101, 28))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(10)
        ...
        self.txt_ClosedTicketFile = QtWidgets.QPlainTextEdit(Form)
        self.txt_ClosedTicketFile.setGeometry(QtCore.QRect(140, 80, 491, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.txt_ClosedTicketFile.setFont(font)
        self.txt_ClosedTicketFile.setPlainText("")
        self.txt_ClosedTicketFile.setObjectName("txt_ClosedTicketFile")
